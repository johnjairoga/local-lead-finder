...
import { Star, Phone, MapPin, LayoutDashboard, ArrowLeft } from "lucide-react";
      ...
      {isCompleted && businesses.length > 0 && (
        <div className="space-y-4">
          <h2 className="text-lg font-semibold text-slate-800">
            Resultados — {businesses.length} negocios
          </h2>
          ...
          <div className="rounded-2xl border-2 border-primary/20 bg-primary/5 p-6 text-center">
            ...
            <p className="mb-5 text-sm text-slate-500">
              Inicia sesión para acceder a tu dashboard con todos tus resultados
              actuales e históricos, filtrar por estado y hacer seguimiento.
            </p>
